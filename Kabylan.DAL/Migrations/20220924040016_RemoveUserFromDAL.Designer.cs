...
namespace Kabylan.DAL.Migrations
{
    ...
    [Migration("20220924040016_RemoveUserFromDAL")]
    partial class RemoveUserFromDAL
    {
            ...
            modelBuilder.Entity("Kabylan.DAL.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2022, 9, 24, 0, 0, 0, 0, DateTimeKind.Local),
                            MoneyCount = 100,
                            SaleId = 1
                        });
                });
            ...
            modelBuilder.Entity("Kabylan.DAL.Models.Sale", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            PayingMonths = 1,
                            SaleDate = new DateTime(2022, 9, 24, 0, 0, 0, 0, DateTimeKind.Local)
                        });
                });
